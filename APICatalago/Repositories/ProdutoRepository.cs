...
namespace APICatalago.Repositories
{
    public class ProdutoRepository : Repository<Produto>, IProdutoRepository
    {
        ...
        public async Task<PagedList<Produto>> GetProdutosAsync(ProdutosParameters produtosParams)
        {
            ...
            var produutosOrdenados = produtos.OrderBy(p => p.ProdutoId).AsQueryable();

            var resultado = PagedList<Produto>.ToPagedList(produutosOrdenados, produtosParams.PageNumber, produtosParams.PageSize);
            return resultado;    
        }
